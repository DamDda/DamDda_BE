...
public class QProjectImage extends EntityPathBase<ProjectImage> {
    ...
    private static final long serialVersionUID = 1124317216L;
    ...
    public final QProjectImageType imageType;
    ...
    public QProjectImage(Class<? extends ProjectImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.imageType = inits.isInitialized("imageType") ? new QProjectImageType(forProperty("imageType")) : null;
