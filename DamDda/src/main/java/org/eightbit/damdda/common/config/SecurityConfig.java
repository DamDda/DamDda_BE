...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(clientUrl));  // 허용할 클라이언트 도메인
        config.setAllowedMethods(List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));  // 허용할 메서드
        config.setAllowedHeaders(List.of("Authorization", "Content-Type","Access-Control-Allow-Origin"));  // 허용할 요청 헤더
